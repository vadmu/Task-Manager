...
#            self.taskList.append(eval(taskType)(name, regions = regions, logic = logic))
            ...
            self.taskList[0].updateData.connect(self.updateData)
            self.taskList[0].clearData.connect(self.clearData)
            self.layoutChanged.emit()  
    ...
    def updateData(self, datax, datay):    
        self.plotter.newData([datax, datay])
    ...
    def start(self):
        ...
        if self.currentTask < len(self.taskList):
            if self.isFinished:
                ...
                self.taskList[self.currentTask].updateData.connect(self.updateData)
                self.taskList[self.currentTask].clearData.connect(self.clearData)
    ...
    def startNext(self):
        ...
        self.taskList[self.currentTask].updateData.disconnect(self.updateData)
        self.taskList[self.currentTask].clearData.disconnect(self.clearData)
...
class MainW(QtGui.QWidget):   
    ...
    def setupLayout(self):
        ...
        self.plotter.setSizePolicy(QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Expanding))        
...
#        self.btnCopy.setDisabled(True)
    ...
    def setupConnections(self):
        ...
        self.ttModel.updateTotalProgress.connect(self.updateState)
